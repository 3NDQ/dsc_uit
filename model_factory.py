...
def get_tokenizer(tokenizer_name):
    try:
        ...
        logging.info(f"Loaded tokenizer \"{tokenizer_name}\" successfully.")
        return tokenizer
...
def get_text_encoder(model_name):
    try:
        ...
        logging.info(f"Loaded text encoder \"{model_name}\" successfully.")
        return text_encoder
    except Exception as e:
...
def get_image_encoder(model_name):
    try:
        ...
        logging.info(f"Loaded image encoder \"{model_name}\" successfully.")
